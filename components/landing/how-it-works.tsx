    ...
    <section id="how-it-works" className="px-4 py-20 sm:px-6 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-2xl">
          ...
          <h2 className="text-balance font-sans text-3xl font-bold leading-tight tracking-tight text-foreground sm:text-4xl">
            Send it the way it already lands in your inbox.
          </h2>
        </div>
