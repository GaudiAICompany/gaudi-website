            ...
            <CardContent className="p-0">
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <Input placeholder="First Name" type="text" className="bg-white/12 border-white/20 text-white h-12 placeholder-white/80" required />
                  <Input placeholder="Last Name" type="text" className="bg-white/12 border-white/20 text-white h-12 placeholder-white/80" required />
                </div>
                <Input
                  type="email"
                  ...
                  required
                />
                <Input placeholder="Company Name" type="text" className="bg-white/12 border-white/20 text-white h-12 placeholder-white/80" required />
                <textarea
